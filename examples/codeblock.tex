...
\begin{codeblock}[label=esempioReference]{cpp}{main.cpp}
#include <iostream>
use namespace std;
...
Puoi far riferimento ad un blocco di codice aggiungendo a questo una label e citandolo mediante \textbackslash{}ref (vedi \ref{esempioReference}).